...
($0.7936$ vs $0.7947$) are correctly described as ties. This reframes the deliverable: the
enduring value is the protocol and the ablation evidence, not rank order.
...
\begin{table}[h]
      ...
      \begin{tabular}{lccl}
            ...
            GraphSAGE + weight & 0.651 & [0.526, 0.770] & 0.244\\
            \bottomrule
      \end{tabular}
\end{table}
