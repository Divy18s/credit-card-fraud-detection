...
false-positive rate (Section~\ref{sec:headtohead}). Against every other published figure the
...
shuffled splits across several seeds to put an interval on the inflation estimate itself; larger
